    ...
    <MaxWidthWrapper>
      ...
      max-w-3xl">
        ...
        max-w-prose text-muted-foreground">
          Welcome to DigitalHippo. Every asset 
          on our platform is verified by our 
          team to ensure our highest quality 
          standards.
        </p>
        <div
        className="flex flex-col 
        sm:flex-row gap-4 mt-6">
          <Link 
          href='/products'
        ...
        lg:gap-x-8 lg:gap-y-0">
            {perks.map((perk) => (
              ...
              lg:text-center">
                ...
                <div
                className="mt-6 md:ml-4 md:mt-0 lg:ml-0 lg:mt-6 ">
                  <h3 
